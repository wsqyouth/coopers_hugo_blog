...
使用Markdown 语法功能编辑器有一个十分头疼的问题：粘贴出来的代码，格式错乱，空间小还带行号，而且特别丑。Markdown.com.cn 编辑器能够解决这个问题。
...
Markdown 语法功能仅支持公众号文章链接，即域名为`https://mp.weixin.qq.com/`的合法链接。使用方法如下所示：
...
> 支持平台：微信代码主题仅支持Markdown 语法功能！其他主题无限制。
...
- yyy [wechat-fromat](https://github.com/lyricat/wechat-format "灵感来源")
- xxx [MD2All](http://md.aclickall.com/ "MdA2All")
